    ...
    <main class="main">
      ...
      <section class="panel filter-panel">
        ...
        <form class="filter-row filter-row-main" id="searchForm" method="get"
              action="${pageContext.request.contextPath}/vendor/order.htm">
          ...
          <a class="btn btn-outline btn-sm" href="${pageContext.request.contextPath}/vendor/order.htm">초기화</a>
        ...
        <section class="panel table-panel">
                          ...
                          <div class="product-cell">
                            <span class="thumb" style="display:block; width:44px; height:44px; overflow:hidden;">
                              <c:if test="${not empty order.thumbnailUrl}">
                                <img src="${img:url(order.thumbnailUrl)}" alt="${order.productName}"
          ...
          <c:if test="${totalPages > 1}">
            <nav class="pagination" aria-label="페이지 이동">
              ...
              <c:if test="${page > 1}">
                <c:url var="prevPageUrl" value="/vendor/order.htm">
              ...
              <c:forEach var="p" begin="1" end="${totalPages}">
                <c:url var="pageUrl" value="/vendor/order.htm">
                  <c:param name="startDate" value="${searchStartDate}" />
                  <c:param name="endDate" value="${searchEndDate}" />
                  <c:param name="orderStatus" value="${searchOrderStatus}" />
                  <c:param name="deliveryStatus" value="${searchDeliveryStatus}" />
              ...
              <c:if test="${page < totalPages}">
                <c:url var="nextPageUrl" value="/vendor/order.htm">
                  <c:param name="startDate" value="${searchStartDate}" />
                  <c:param name="endDate" value="${searchEndDate}" />
                  <c:param name="orderStatus" value="${searchOrderStatus}" />
                  <c:param name="deliveryStatus" value="${searchDeliveryStatus}" />
        ...
        <aside class="side-col">
          ...
          <section class="panel">
            ...
            <div class="quick-menu">
              <a href="${pageContext.request.contextPath}/vendor/product_write.htm" class="quick-menu-item">
