...
<%@ taglib prefix="img" uri="/WEB-INF/goodpang-functions.tld"%>
    ...
    <main class="main">
      ...
      <!-- 상품 필터 -->
      <form class="filter-row" method="get" action="${pageContext.request.contextPath}/vendor/product_options.htm" style="margin-bottom: 12px;">
                          ...
                          <div class="product-cell">
                            <span class="thumb" style="display:block; width:44px; height:44px; overflow:hidden;">
                              <c:if test="${not empty group.thumbnailUrl}">
                                <img src="${img:url(group.thumbnailUrl)}" alt="${group.productName}"
                                     style="width:44px; height:44px; object-fit:cover; border-radius:6px;">
                              </c:if>
                            </span>
                            <div class="product-text">
                              <p class="product-name">
                                <a href="${pageContext.request.contextPath}/vendor/product_detail.htm?productNo=${group.productNo}"
