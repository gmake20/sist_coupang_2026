				...
				<div class="header-main">
					...
					<form class="search-form"
						...
						<button type="submit" class="search-btn" title="검색">
							...
							<img
								src="${pageContext.request.contextPath}/resources/images/icons/search.png"
					...
					<ul class="icon-menus">
						...
						<li class="my-coupang"><a
							href="${pageContext.request.contextPath}/order/order_list"> <img
								src="${pageContext.request.contextPath}/resources/images/icons/person.png"
						...
						<li class="cart"><a
							href="${pageContext.request.contextPath}/cart"> <img
								src="${pageContext.request.contextPath}/resources/images/icons/cart.png"
						...
						<div class="gnb-menu-viewport">
							...
							<ul class="gnb-menu-scroll">
								...
								<li class="gnb-menu-item"><a href="#"> <img
										src="${pageContext.request.contextPath}/resources/images/gnb/coupang-play.png"
										alt=""> <span> 굿팡플레이 </span>
								...
								<li class="gnb-menu-item"><a href="#"> <img
										src="${pageContext.request.contextPath}/resources/images/gnb/rocket-delivery.png"
										alt=""> <span> 로켓배송 </span>
								...
								<li class="gnb-menu-item"><a href="#"> <img
										src="${pageContext.request.contextPath}/resources/images/gnb/rocket-fresh.png"
										alt=""> <span> 로켓프레시 </span>
								...
								<li class="gnb-menu-item"><a href="#"> <img
										src="${pageContext.request.contextPath}/resources/images/gnb/fbi_icon_3x.png"
								...
								<li class="gnb-menu-item"><a href="#"> <img
										src="${pageContext.request.contextPath}/resources/images/gnb/biz.png"
										alt=""> <span> 굿팡비즈 </span>
								...
								<li class="gnb-menu-item"><a href="#"> <img
										src="${pageContext.request.contextPath}/resources/images/gnb/oversea-delivery.png"
										alt=""> <span> 로켓직구 </span>
								...
								<li class="gnb-menu-item"><a href="#"> <img
										src="${pageContext.request.contextPath}/resources/images/gnb/gold-box.png"
										alt=""> <span> 골드박스 </span>
								...
								<li class="gnb-menu-item"><a href="#"> <img
										src="${pageContext.request.contextPath}/resources/images/gnb/new-item-of-month.png"
								...
								<li class="gnb-menu-item"><a href="#"> <img
										src="${pageContext.request.contextPath}/resources/images/gnb/sell-on-coupang.png"
										alt=""> <span> 입점신청 </span>
								...
								<li class="gnb-menu-item"><a href="#"> <img
										src="${pageContext.request.contextPath}/resources/images/gnb/omp.png"
										alt=""> <span> 판매자특가 </span>
								...
								<li class="gnb-menu-item"><a href="#"> <img
										src="${pageContext.request.contextPath}/resources/images/gnb/wow.png"
								...
								<li class="gnb-menu-item"><a href="#"> <img
										src="${pageContext.request.contextPath}/resources/images/gnb/benefit.png"
								...
								<li class="gnb-menu-item"><a href="#"> <img
										src="${pageContext.request.contextPath}/resources/images/gnb/returned-market.png"
										alt=""> <span> 반품마켓 </span>
								...
								<li class="gnb-menu-item"><a href="#"> <img
										src="${pageContext.request.contextPath}/resources/images/gnb/sustainable-market.png"
								...
								<li class="gnb-menu-item"><a href="#"> <img
										src="${pageContext.request.contextPath}/resources/images/gnb/event.png"
										alt=""> <span> 기획전 </span>
								...
								<li class="gnb-menu-item"><a href="#"> <img
										src="${pageContext.request.contextPath}/resources/images/gnb/travel.png"
