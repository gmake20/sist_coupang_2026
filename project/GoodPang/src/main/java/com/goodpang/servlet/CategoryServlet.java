...
public class CategoryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("inertFilterGroups", buildInertFilterGroups());
     ...
     */
    private Map<String, String[]> buildInertFilterGroups() {
        Map<String, String[]> groups = new LinkedHashMap<>();
        groups.put("배송", new String[] { "로켓럭셔리", "로켓배송", "쿠팡글로벌", "탑브랜드" });
        groups.put("무료배송", new String[] { "무료배송" });
        ...
        groups.put("출시년도/제조년도", new String[] { "2023", "2022", "2021", "2020" });
