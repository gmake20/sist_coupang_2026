...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/wow_membership.css">
</head>
<body>
                ...
                <section class="wow-card">
                    <div class="wow-card-header">
                        ...
                        <p class="wow-next-payment">
                            다음 결제 예정일은 <strong>${nextPaymentDate}</strong> 입니다.
                        </p>
                    </div>
                    ...
                    <div class="wow-saving-total">
                        총 <strong><fmt:formatNumber value="${savingAmount}" pattern="#,##0" /></strong>원
                    </div>

                    <div class="wow-saving-box">
                        <div class="wow-saving-row">
                            <span>무료배송 (건당 3,000원)</span>
                            <strong><fmt:formatNumber value="${deliverySaving}" pattern="#,##0" />원</strong>
                        </div>
                        ...
                        <div class="wow-saving-row">
                            <span>쿠팡 할인</span>
                            <strong><fmt:formatNumber value="${discountSaving}" pattern="#,##0" />원</strong>
                        </div>

                        <div class="wow-saving-row">
                            <span>쿠팡이츠 혜택</span>
                            <strong><fmt:formatNumber value="${eatsSaving}" pattern="#,##0" />원</strong>
                        </div>

                        <div class="wow-saving-row">
                            <span>쿠팡캐시 적립</span>
                            <strong><fmt:formatNumber value="${cashSaving}" pattern="#,##0" />원</strong>
                        </div>

                        <div class="wow-saving-row">
                            <span>30일 무료반품 (건당 5,000원)</span>
                            <strong><fmt:formatNumber value="${returnSaving}" pattern="#,##0" />원</strong>
                        </div>

                        <div class="wow-saving-row">
                            <span>로켓직구 무조건 무료배송 (건당 2,500원)</span>
                            <strong><fmt:formatNumber value="${globalSaving}" pattern="#,##0" />원</strong>
                        </div>
                    </div>
...
<c:if test="${sessionScope.wowMember}">
    <div id="wowCancelModal" class="wow-cancel-overlay">
        <div class="wow-cancel-modal">
            ...
            <p>
                해지하면 무료배송, 무료반품 등 와우 전용 혜택을 더 이상 이용할 수 없습니다.
            </p>

            <form action="${pageContext.request.contextPath}/wow/cancel" method="post">
                <div class="wow-cancel-buttons">
                    <button type="button" id="wowCancelKeepBtn" class="wow-cancel-keep">
                        멤버십 유지하기
                    </button>

                    <button type="submit" class="wow-cancel-submit">
                        해지하기
                    </button>
                </div>
            </form>
