    ...
    <div class="top-bar">
        <div class="top-bar-inner">
            ...
            <ul class="top-bar-right">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/vendor-signup.html">
                        판매자 가입
                    </a>
                </li>
                <li class="cs-center">
            ...
            <div class="header-col">
                ...
                <div class="header-main">
                    ...
                    <form class="search-form"
                        ...
                        <div class="select--category">
                            ...
                            <a href="#"
                               class="select--category__current">
                                전체
                            </a>

                            <span class="select--category--button"></span>
                        ...
                        <div class="header-search">
                            ...
                            <div class="headerPopupWords popularity-words">
                                ...
                                <div class="history-btns">
                                    ...
                                    <span class="delete-all-kwdhistory del-button">
                                        전체삭제
                                    </span>

                                    <span class="history-on-off on">
                                        최근검색어끄기
                                    </span>
                ...
                <div class="search-row">
                    ...
                    <form class="search-form"
                        ...
                        <div class="header-search">
                            ...
                            <label for="search-keyword-tablet"
                                   class="blind">
                                상품 검색
                            </label>
                ...
                <nav class="gnb">
                    ...
                    <div class="gnb-menu-container">
                        ...
                        <button type="button"
                                class="gnb-menu-btn gnb-menu-btn-left"
                                disabled>
